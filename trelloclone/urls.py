...
urlpatterns = patterns('',
    ...
    url(r'api/v1/walls/$', views.WallList.as_view(), name='wall-list'),
    url(r'api/v1/walls/(?P<pk>[0-9]+)/$', views.WallDetail.as_view(), name='wall-detail'),
    url(r'api/v1/walls/(?P<wall_pk>[0-9]+)/boards/$', views.BoardList.as_view(), name='board-list'),
    ...
    url(r'api/v1/cards/$', views.CardList.as_view(), name='single-card-list'),
