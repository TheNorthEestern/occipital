...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('trelloclone', ['Card'])


    def backwards(self, orm):
        # Deleting model 'Board'
        db.delete_table('trelloclone_board')

        # Deleting model 'Card'
        db.delete_table('trelloclone_card')
